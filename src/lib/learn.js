...
const ES = {
  ...
  fakewindow: "https://www.incibe.es/aprendeciberseguridad/phishing",
  svgscript: "https://www.incibe.es/aprendeciberseguridad/malware",
  ...
  clipswap: "https://www.incibe.es/aprendeciberseguridad/fraude-online",
  walletsign: "https://ethereum.org/es/security/",
  seedphrase: "https://ethereum.org/es/security/",
  promptinject: "https://owasp.org/www-project-top-10-for-large-language-model-applications/",
  iframes: "https://owasp.org/www-community/attacks/Clickjacking",
  permissions: "https://www.osi.es/es/tu-informacion-personal",
  notifbait: "https://www.osi.es/es/campanias/fraudes-en-la-red",
...
const INTL = {
  ...
  fakewindow: "https://owasp.org/www-community/attacks/Phishing",
  svgscript: "https://attack.mitre.org/techniques/T1027/006/",
  ...
  clipswap: "https://attack.mitre.org/techniques/T1565/002/",
  walletsign: "https://ethereum.org/en/security/",
  seedphrase: "https://ethereum.org/en/security/",
  promptinject: "https://owasp.org/www-project-top-10-for-large-language-model-applications/",
  iframes: "https://owasp.org/www-community/attacks/Clickjacking",
  permissions: "https://developer.mozilla.org/docs/Web/API/Permissions_API",
  notifbait: "https://developer.mozilla.org/docs/Web/API/Notifications_API",
